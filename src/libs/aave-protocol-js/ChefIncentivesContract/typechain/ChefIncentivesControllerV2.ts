...
export declare namespace ChefIncentivesControllerV2 {
...
export interface ChefIncentivesControllerV2Interface extends utils.Interface {
  functions: {
...
export interface ChefIncentivesControllerV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChefIncentivesControllerV2Interface;
  ...
  functions: {
    ...
    userInfo(
      ...
      user: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[ChefIncentivesControllerV2.UserInfoStructOutput]>;
  };
  ...
  userBaseClaimable(user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
