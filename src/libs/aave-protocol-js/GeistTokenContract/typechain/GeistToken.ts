...
export interface GeistTokenInterface extends utils.Interface {
  functions: {
...
export interface GeistToken extends BaseContract {
  ...
  callStatic: {
    ...
    setMinter(_minter: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
