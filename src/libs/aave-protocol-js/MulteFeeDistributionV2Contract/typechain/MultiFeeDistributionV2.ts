...
export interface MultiFeeDistributionV2Interface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: 'totalAccountLocked',
    values: [PromiseOrValue<string>]
  ): string;
...
export interface MultiFeeDistributionV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultiFeeDistributionV2Interface;
