...
import { MultiFeeDistributionUNIV3POS } from './typechain/MultiFeeDistributionUNIV3POS';
import { MultiFeeDistributionUNIV3POS__factory } from './typechain/MultiFeeDistributionUNIV3POS__factory';
import getNumberFromEtherBigNumber from '../getNumberFromEtherBigNumber';

export class MultiFeeDistributionV3Service extends BaseService<MultiFeeDistributionUNIV3POS> {
  ...
  constructor(
    ...
    super(provider, MultiFeeDistributionUNIV3POS__factory);
  ...
  // ): Promise<BigNumber[]> {
  //   const multiFeeDistributionContract: MultiFeeDistributionUNIV3POS = this.getContractInstance(
  ...
  public async exit(user: tEthereumAddress) {
    ...
    return this.generateTxCallback({
      rawTxMethod: () => multiFeeDistributionContract.populateTransaction.exit(user),
      from: user,
    });
  }
