...
export class IUniswapV3Factory extends Contract {
  ...
  functions: {
    ...
    'setOwner(address)'(_owner: string, overrides?: Overrides): Promise<ContractTransaction>;
  };
  ...
  callStatic: {
    ...
    'setOwner(address)'(_owner: string, overrides?: CallOverrides): Promise<void>;
  };

  filters: {
    FeeAmountEnabled(fee: BigNumberish | null, tickSpacing: BigNumberish | null): EventFilter;
  ...
  estimateGas: {
    ...
    'setOwner(address)'(_owner: string, overrides?: Overrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    setOwner(_owner: string, overrides?: Overrides): Promise<PopulatedTransaction>;

    'setOwner(address)'(_owner: string, overrides?: Overrides): Promise<PopulatedTransaction>;
  };
}
