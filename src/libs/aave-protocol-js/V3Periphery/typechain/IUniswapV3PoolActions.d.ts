...
export class IUniswapV3PoolActions extends Contract {
  ...
  functions: {
    ...
    initialize(sqrtPriceX96: BigNumberish, overrides?: Overrides): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    initialize(sqrtPriceX96: BigNumberish, overrides?: Overrides): Promise<BigNumber>;

    'initialize(uint160)'(sqrtPriceX96: BigNumberish, overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    initialize(sqrtPriceX96: BigNumberish, overrides?: Overrides): Promise<PopulatedTransaction>;
