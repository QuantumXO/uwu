...
export class NFTDescriptorTest extends Contract {
  ...
  'addressToString(address)'(_address: string, overrides?: CallOverrides): Promise<string>;
  ...
  'feeToPercentString(uint24)'(fee: BigNumberish, overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    'addressToString(address)'(_address: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    'feeToPercentString(uint24)'(fee: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
