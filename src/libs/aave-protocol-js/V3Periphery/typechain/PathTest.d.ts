...
export class PathTest extends Contract {
  ...
  'getFirstPool(bytes)'(path: BytesLike, overrides?: CallOverrides): Promise<string>;
  ...
  'hasMultiplePools(bytes)'(path: BytesLike, overrides?: CallOverrides): Promise<boolean>;

  skipToken(path: BytesLike, overrides?: CallOverrides): Promise<string>;

  'skipToken(bytes)'(path: BytesLike, overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    'decodeFirstPool(bytes)'(path: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;

    getFirstPool(path: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;

    'getFirstPool(bytes)'(path: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    'hasMultiplePools(bytes)'(path: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;

    skipToken(path: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;

    'skipToken(bytes)'(path: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    'skipToken(bytes)'(path: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
