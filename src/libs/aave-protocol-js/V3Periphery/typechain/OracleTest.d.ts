...
interface OracleTestInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getOldestObservationSecondsAgo', values: [string]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'getChainedPrice', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'getOldestObservationSecondsAgo', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'getQuoteAtTick', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'getWeightedArithmeticMeanTick', data: BytesLike): Result;
...
export class OracleTest extends Contract {
  ...
  estimateGas: {
    consult(pool: string, secondsAgo: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    getBlockStartingTickAndLiquidity(pool: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    getOldestObservationSecondsAgo(pool: string, overrides?: CallOverrides): Promise<BigNumber>;
