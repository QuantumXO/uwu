...
interface PositionValueTestInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'feesGas', values: [string, BigNumberish]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'principalGas', data: BytesLike): Result;
...
export class PositionValueTest extends Contract {
  ...
  feesGas(nft: string, tokenId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  estimateGas: {
    fees(nft: string, tokenId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
