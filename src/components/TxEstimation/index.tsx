...
// TODO: поменять интервал для прода
const INTERVAL = 100000;
// TODO: поменять на 250 для прода
const UPDATE_GAS_PRICE_INTERVAL = 100000;
...
export default function TxEstimation({ getTransactionsData, amount }: TxEstimationProps) {
  ...
  useEffect(() => {
    ...
    timeout = window.setTimeout(updateGasPrice, UPDATE_GAS_PRICE_INTERVAL);
